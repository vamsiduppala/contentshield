  ...
  return (
    <DashboardLayout>
      <motion.header className="mb-5" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="mt-4 max-w-3xl leading-8 text-white/56">Mock frontend state only. Every beep, mute, blur, replacement, fix, ignore, and note is tracked as a Finding Action without modifying video files.</p>
      </motion.header>
